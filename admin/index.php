  ...
  <div class="columns">
    ...
    <div class="content column is-10">
      ...
      <div class="nav menu">
        <div class="container">
          ...
          <div class="nav-left is-hidden-mobile">
            <a href="index.php" class="nav-item is-tab is-active"> All</a>
            <a href="requests.php" class="nav-item is-tab"> Requests</a>
      ...
      <?php
        ...
        $query = $conn->query(" SELECT * FROM `items` WHERE allow = 1 ORDER BY date_added DESC");
        if($query->num_rows!=0){
